...
function createStack(template, stackName, callback) {
  ...
  var params = {
    ...
    //
    // Pass al paramaters in here. e.g. bitnamiUser
    //
    // Parameters: [
    //   {
  ...
  /**
    ...
    TODO:
    - Create a method that makes a call to the describeStacks method
    - return the status to the client so the initialising is more responsive
    - Like the bitnami dashboard use each status as a percentage progress marker
